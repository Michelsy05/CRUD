	            ...
	            <div class="col-lg-4 col-md-6 col-sm-8 mx-auto">
	               ...
	               <div v-if="!registerActive" class="card p-5">
	                  ...
	                  <form class="form-group" id="login">
	                     <input v-model="email" type="email" name="email" class="form-control" placeholder="Correo electronicos" required>
	                     ...
	                     <p>¿No tienes una cuenta? <a href="#" @click="registerActive = !registerActive,  cleanInputs()">Registrese ahora mismo</a>
	                     </p>
	                  </form>
	               </div>
	               ...
	               <div v-else class="card p-5">
	                  ...
	                  <form class="form-group" id="register">
	                     <input v-model="name" name="name" type="text" class="form-control" placeholder="Nombre Completo" required>
	                     <input v-model="email" name="email" type="email" class="form-control" placeholder="Correo electronico" required>
	                     <input v-model="password" name="password" type="password" class="form-control" placeholder="Contraseña" required>
	                     ...
	                     <p>¿Ya tienes una cuenta? <a href="#" @click="registerActive = !registerActive, cleanInputs()">Inciar sesión</a>
	                     </p>
	                  </form>
	               </div>
	            </div>
