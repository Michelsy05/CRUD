	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="appModalLabel">Crear tarea</h5>
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" @click="apiNewTask" type="button" class="btn btn-primary" data-bs-dismiss="modal">Guardar</button>
	      </div>
	  		</form>
	    </div>
	  </div>
